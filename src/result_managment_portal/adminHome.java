...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EEE", "CS", "IT", "ECE", "Mech" }));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_managment_portal/icons8-save-24.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            String query = "INSERT INTO student(rollno, cource, branchName, name, gender, fatherName) "
                     + "VALUES('" + roll + "','" + cource + "','" + branchName + "','" + name + "','" + gender + "','" + fatherName + "')";
